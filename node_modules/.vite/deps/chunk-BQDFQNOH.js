...
function each(node, flags, get_collection, get_key, render_fn, fallback_fn = null) {
  ...
  var state2 = { effect: effect2, flags, items, first };
  first_run = false;
  if (hydrating) {
    anchor = hydrate_node;
  }
...
function create_item(anchor, prev, value, key2, index2, render_fn, flags, get_collection) {
...
//# sourceMappingURL=chunk-BQDFQNOH.js.map
